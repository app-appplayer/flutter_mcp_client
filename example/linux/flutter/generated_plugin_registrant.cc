...
#include <flutter_mcp_client/flutter_mcp_client_plugin.h>
#include <flutter_mcp_common/flutter_mcp_common_plugin.h>
#include <flutter_secure_storage_linux/flutter_secure_storage_linux_plugin.h>

void fl_register_plugins(FlPluginRegistry* registry) {
  g_autoptr(FlPluginRegistrar) flutter_mcp_client_registrar =
      fl_plugin_registry_get_registrar_for_plugin(registry, "FlutterMcpClientPlugin");
  flutter_mcp_client_plugin_register_with_registrar(flutter_mcp_client_registrar);
